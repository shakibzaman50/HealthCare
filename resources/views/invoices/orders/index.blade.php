...
@section('title', $order_type ==4 ?'Wholesaler Invoice List':'Supplier Invoice List')
...
@section('content')
<div class="card p-2">
    <h5 class="card-header">{{ $order_type ==4 ?'Wholesaler':'Supplier' }} Invoice List</h5>
    <div class="p-4">
    ...
    <table class="table">
        <thead>
            <tr>
                <th>ID</th>
                <th>Date</th>
                <th>{{ $order_type ==4 ?'Wholesaler Name':'Supplier name' }}</th>
                <th>Invoice</th>
                <th>Total</th>
                <th>Discount</th>
