...
@section('content')
    ...
    <div class="card text-bg-theme">
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate action="{{ route('heart-rate-units.heart-rate-unit.update', $heartRateUnit->id) }}" id="edit_heart_rate_unit_form" name="edit_heart_rate_unit_form" accept-charset="UTF-8" >
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('heart_rate_units.form', [
