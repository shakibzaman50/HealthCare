...
@section('title', 'Order Profits Report')
...
@section('content')
<div class="card p-2">
    <h4>Orders Profit List</h4>
    <form method="GET" action="{{ route('report-order-profit') }}" class="mb-4">
        ...
        <div class="row">
            ...
            <div class="col-md-2 align-self-end">
                <a href="{{ route('report-order-profit') }}" class="btn btn-primary">Clear</a>
            </div>
        </div>
    </form>

    <div class="card-datatable table-responsive">
        @include('reports.include.list-grid')
