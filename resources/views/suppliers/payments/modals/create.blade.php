<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#supplierModal_{{ $user->id }}">
    Payment
</button>

<!-- Large Modal -->
<div class="modal fade" id="supplierModal_{{ $user->id }}" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="container mx-auto p-4">
                    ...
                    <form action="{{ route('payments.store') }}" method="POST">
                        @csrf
                        <input type="hidden" value="{{ config('app.transaction_payable_type.supplier') }}"
                            name="payable_type">
