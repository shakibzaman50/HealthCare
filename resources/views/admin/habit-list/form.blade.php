...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" type="text" id="name" value="{{ old('name', optional($habitList)->name) }}" minlength="1" maxlength="30" placeholder="Enter name here...">
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <div class="form-check checkbox mt-3">
            <input id="is_active_1" class="form-check-input" name="is_active" type="checkbox" value="1" {{ old('is_active', optional($habitList)->is_active) == '1' ? 'checked' : '' }}>
