...
<div class="card text-bg-theme">
    ...
    <div class="card-header d-flex justify-content-between align-items-center p-3">
        ...
        <div>
            <form method="POST" action="{!! route('physical-conditions.destroy', $physicalCondition->id) !!}"
                accept-charset="UTF-8">
                <input name="_method" value="DELETE" type="hidden">
                {{ csrf_field() }}

                <a href="{{ route('physical-conditions.edit', $physicalCondition->id ) }}" class="btn btn-primary"
