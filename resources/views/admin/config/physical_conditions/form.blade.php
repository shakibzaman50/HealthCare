...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" type="text" id="name" value="{{ old('name', optional($physicalCondition)->name) }}" minlength="1" maxlength="255" placeholder="Enter name here...">
