                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            <form method="POST"
                                action="{!! route('physical-conditions.destroy', $physicalCondition->id) !!}"
                                accept-charset="UTF-8">
                                <input name="_method" value="DELETE" type="hidden">
                                {{ csrf_field() }}

                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="{{ route('physical-conditions.show', $physicalCondition->id ) }}"
                                        class="btn btn-info" title="Show Physical Condition">
                                        <span class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></span>
                                    </a>
                                    <a href="{{ route('physical-conditions.edit', $physicalCondition->id ) }}"
