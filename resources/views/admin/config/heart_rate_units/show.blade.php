    ...
    <div class="card-header d-flex justify-content-between align-items-center p-3">
        ...
        <div>
            <form method="POST" action="{!! route('heart-rate-units.destroy', $heartRateUnit->id) !!}"
                ...
                <a href="{{ route('heart-rate-units.edit', $heartRateUnit->id ) }}" class="btn btn-primary"
                    title="Edit Heart Rate Unit">
                ...
                <a href="{{ route('heart-rate-units.index') }}" class="btn btn-primary"
                    title="Show All Heart Rate Unit">
