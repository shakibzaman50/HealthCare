    ...
    <div class="card text-bg-theme">
        ...
        <div class="card-header d-flex justify-content-between align-items-center p-3">
            ...
            <div>
                ...
                <a href="{{ route('medicine-types.create') }}" class="btn btn-secondary"
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate
                  action="{{ route('medicine-types.update', $medicineType->id) }}" id="edit_medicine_type_form"
                  name="edit_medicine_type_form" accept-charset="UTF-8">
                {{ csrf_field() }}
